...
@destination1 = Destination.create!(
  ...
  decsription: 'Iceland, a Nordic island nation, is defined by its dramatic landscape with volcanoes, geysers, hot springs and lava fields. Massive glaciers are protected in Vatnajökull and Snæfellsjökull national parks. Most of the population lives in the capital, Reykjavik, which runs on geothermal power and is home to the National and Saga museums, tracing Iceland’s Viking history.', 
...
@activity1 = Activity.create!(
  ...
  decsription: 'This church’s stark concrete façade was designed to mimic the Icelandic landscape. It’s the tallest building in Reykjavík, and, for a small fee, you can go up to the top to get incredible shots of the city and its multicolored rooftops.',
...
@activity2 = Activity.create!(
  name: 'Visit Perlan',
  decsription: 'This dome-shaped building called “The Pearl” offers another great place to get a view of the city and houses a museum. On clear days you can see as far as Snæfellsjökull, the 700,000-year-old glacier-capped volcano that sits on the western coast of the island. Inside the dome, there is a cocktail bar and restaurant, so it makes for a nice place to go out and enjoy the view.',
...
@activity3 = Activity.create!(
  ...
  decsription: 'Rated the 2nd best beach in the world, visit the acclaimed public white-sand beach featuring calm waters & easy access to island resorts.',
...
@activity4 = Activity.create!(
  ...
  decsription: 'Easy to navigate and walk around, the city’s signature different-colored buildings and architecture are endlessly unique and fascinating. Just taking a walk around and visiting different shops and cafes is well worth your time, and as a bonus there are trolleys that take you around town for free! Make sure to visit popular sights in downtown Old San Juan you can explore free of charge.',
...
@activity5 = Activity.create!(
  ...
  decsription: 'One of three bioluminescent bays in Puerto Rico, take a nighttime kayaking tour to see the bay glow fluorescent.',
